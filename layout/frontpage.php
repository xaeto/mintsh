...
/**
 * Theme mintsh - Frontpage layout
 *
 * This layoutfile is based on theme/boost/layout/drawers.php and theme/boost_union/layout/theme_boost/drawers.php
 *
...
// mintsh footer
require_once(__DIR__ . '/includes_mintsh/footer.php');

// Render drawers.mustache from theme_boost (which is overridden in theme_boost_union).
echo $OUTPUT->render_from_template('theme_mintsh/frontpage', $templatecontext);
