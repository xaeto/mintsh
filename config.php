...
$THEME->scss = function($theme) {
    return theme_mintsh_get_main_scss_content($theme);
};
...
$THEME->extrascsscallback = 'theme_mintsh_get_extra_scss';
$THEME->prescsscallback = 'theme_mintsh_get_pre_scss';
